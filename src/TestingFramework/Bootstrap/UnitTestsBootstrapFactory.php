...
use Nimut\TestingFramework\Bootstrap\Unit\AbstractBootstrap;
use Nimut\TestingFramework\Bootstrap\Unit\Bootstrap;
use Nimut\TestingFramework\Bootstrap\Unit\LegacyBootstrap;
use Nimut\TestingFramework\Bootstrap\Unit\OldBootstrap;

final class UnitTestsBootstrapFactory
{
    /**
